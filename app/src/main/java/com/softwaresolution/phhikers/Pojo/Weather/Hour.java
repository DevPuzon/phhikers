...
public class Hour {
     ...
     * @param tempC
     */
    public Hour(Integer timeEpoch, String time, Double tempC, Double tempF, Integer isDay, Condition__ condition, Double windMph, Double windKph, Integer windDegree, String windDir, Double pressureMb, Double pressureIn, Double precipMm, Double precipIn, Integer humidity, Integer cloud, Double feelslikeC, Double feelslikeF, Double windchillC, Double windchillF, Double heatindexC, Double heatindexF, Double dewpointC, Double dewpointF, Integer willItRain, String chanceOfRain, Integer willItSnow, String chanceOfSnow, Double visKm, Double visMiles, Double gustMph, Double gustKph) {
        super();
